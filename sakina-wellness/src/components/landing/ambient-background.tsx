...
export function AmbientBackground() {
  ...
  return (
    ...
    >
      ...
      <div
        className="ambient-veil pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_90%_55%_at_50%_0%,rgba(255,249,243,0.5),transparent_62%)] opacity-40"
      />
