...
const FAQ = {
  ...
  mukaino: {
    ru: "Mukaino M-Test — японская система оценки тела через движения и мягкую коррекцию Microcorn. 30–40 минут. Не медицинская диагностика.",
    kz: "Mukaino M-Test — қозғалыс арқылы дене күйін бағалау және Microcorn түзетуі. 30–40 минут. Медициналық диагностика емес."
  },
  contraindications: {
