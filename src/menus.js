...
function messageAlreadyHasMenu(text) {
  ...
  return (
    /Что вам сейчас ближе|Чем помочь сейчас|Қазір сізге не жақын|Қазір қалай көмектесейін/.test(text) ||
    /Можно просто отправить цифру 🤍|Можно отправить цифру|Жай ғана санды жіберсеңіз болады 🤍|Санды жіберуге/.test(text) ||
...
LABEL_TO_ROUTE["подобрать практику по состоянию"] = "concierge";
...
LABEL_TO_ROUTE["күйіңізге сай практика таңдау"] = "concierge";
LABEL_TO_ROUTE["записаться на сеанс"] = "booking";
LABEL_TO_ROUTE["сеансқа жазылу"] = "booking";
LABEL_TO_ROUTE["посмотреть цены"] = "price";
LABEL_TO_ROUTE["бағаларды көру"] = "price";
LABEL_TO_ROUTE["адрес и как добраться"] = "address";
LABEL_TO_ROUTE["мекенжай және жол"] = "address";
...
LABEL_TO_ROUTE["усталость / нет сил"] = "__intent_fatigue__";
LABEL_TO_ROUTE["шаршау / қуат жоқ"] = "__intent_fatigue__";
LABEL_TO_ROUTE["тревога или напряжение"] = "__intent_anxiety__";
LABEL_TO_ROUTE["мазасыздық немесе кернеу"] = "__intent_anxiety__";
LABEL_TO_ROUTE["хочу расслабиться"] = "__intent_need_relaxation__";
LABEL_TO_ROUTE["босанғым келеді"] = "__intent_need_relaxation__";
LABEL_TO_ROUTE["узнать подробнее"] = "concierge_detail";
LABEL_TO_ROUTE["мягко записаться"] = "concierge_book";
LABEL_TO_ROUTE["посмотреть другой вариант"] = "concierge_other";
LABEL_TO_ROUTE["жұмсақ жазылу"] = "concierge_book";
LABEL_TO_ROUTE["басқа нұсқаны көру"] = "concierge_other";
