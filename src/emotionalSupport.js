...
const SUPPORT_REPLIES = {
  ru: {
    general: [
      `Слышу вас 🤍\n\nЗдесь можно не спешить. Вас не осудят и не будут торопить 🌿\n\nЕсли захотите — мягко подскажу о пространстве и практиках. Без давления.`,
  ...
  kz: {
    general: [
      `Естіп тұрмын 🤍\n\nМұнда асықпай болады. Сізді соттамайды және асықтырмайды 🌿`,
...
Если сейчас тяжело — можно без записи. Здесь не торопят 🤍`;
}
