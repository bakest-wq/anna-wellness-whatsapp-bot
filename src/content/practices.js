...
const PRACTICE_DETAILS = {
  five: {
    ru: {
      ...
      effect:
        "Часто отмечают: тепло и расслабление в теле, лёгкость, ощущение «перезагрузки», более спокойный сон и мягкое внутреннее состояние.",
      duration: "2–2,5 часа",
      price: "30 000 ₸",
      closing:
    ...
    kz: {
      ...
      effect:
        "Көбісі: денеде жылу мен босаңсу, жеңілдік, ішкі тыныштық сезімін айтады.",
  ...
  five_fire: {
    ru: {
      ...
      effect:
        "Часто — глубокое расслабление, тепло, мягкость в теле, спокойнее дыхание и внутреннее состояние.",
      duration: "2–2,5 часа",
      price: "35 000 ₸",
      closing:
    ...
    kz: {
      ...
      effect: "Көбіне — терең босаңсу, жылу, тыныш күй және қуатты жұмсақ қалпына келу.",
      duration: "2–2,5 сағат",
      price: "35 000 ₸",
  ...
  five_bamboo: {
    ru: {
      ...
      effect:
        "Нередко — разгрузка в мышцах, тепло, расслабление, лучшее самочувствие на следующий день.",
      duration: "2–2,5 часа",
      price: "33 000 ₸",
      closing:
    ...
    kz: {
      ...
      effect: "Көбіне — бұлшықетте жеңілдік, жылу және босаңсу.",
      duration: "2–2,5 сағат",
      price: "33 000 ₸",
      closing: "Жазылу немесе қарсы көрсетілім? Санды жіберіңіз 🌿"
    }
  ...
  breath: {
    ru: {
      ...
      effect:
        "Многие чувствуют: расслабление, лёгкость, спокойнее мысли, мягче сон и внутреннее восстановление.",
    ...
    kz: {
      ...
      effect: "Көбіне — босаңсу, жеңілдік, тыныш ой және ішкі қалпына келу.",
      duration: "60–90 минут",
      price: "20 000 ₸",
      closing: "Жазылу немесе қарсы көрсетілім? Санды жіберіңіз 🌿"
    }
  ...
  earthflow: {
    ru: {
      ...
      effect:
        "Часто — спокойствие, лёгкость и ощущение обновления.",
      duration: "1 час",
      price: "20 000 ₸",
      closing:
    ...
    kz: {
      ...
      effect: "Көбіне — тыныштық, жеңілдік және жаңарған сезім.",
      duration: "1 сағат",
      price: "20 000 ₸",
      closing: "Жазылу немесе қарсы көрсетілім? Санды жіберіңіз 🌿"
    }
  ...
  bars: {
    ru: {
      ...
      effect:
        "Нередко — глубокий отдых, спокойнее в голове, легче засыпать.",
      duration: "1 час",
      price: "15 000 ₸",
      closing:
