...
const PRACTICE_DETAILS = {
  ...
  mukaino: {
    ru: {
      ...
      what: "Мягкая диагностика движения и баланса тела — чтобы бережно понять, какая практика сейчас ближе.",
      forWho:
        "Если сомневаетесь, с чего начать, или хотите спокойно «настроиться» перед более длинным ритуалом.",
      effect:
        "Часто — яснее ощущения в теле, понимание зон напряжения, спокойнее выбор следующего формата. Не заменяет врача.",
      duration: "30–40 минут",
      price: "10 000 ₸",
      closing:
        "Хотите записаться на M-Test или узнать противопоказания? Напишите цифру 🌿"
    },
    kz: {
      title: "Mukaino M-Test 🌿",
      what: "Қозғалыс пен баланстың жұмсақ бағасы — қазір қай практика жақын екенін абайлап түсінуге.",
      forWho: "Қайдан бастауды білмесеңіз немесе ұзақ ритуал алдында өзіңізді сезінгіңіз келсе.",
      effect: "Көбіне — денеде нақтырақ сезім, кернеу аймақтарын түсіну. Дәрігерді алмастырмайды.",
      duration: "30–40 минут",
      price: "10 000 ₸",
      closing: "Жазылу немесе қарсы көрсетілім? Санды жіберіңіз 🌿"
    }
