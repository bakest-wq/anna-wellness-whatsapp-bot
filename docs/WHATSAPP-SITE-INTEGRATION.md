...
|-----------|----------------|
| «хочу подобрать практику» / «помочь подобрать практику» | Wellness Concierge (без общего меню) |
| «хочу записаться на …» | Booking: практика сохранена → сразу день |
| «хочу узнать подробнее про …» | Карточка практики |
| «хочу выбрать пакет» / «выбрать пакет …» | Package booking flow |
| «хочу узнать цены» | Прайс |
| «адрес» | Адрес |

В логах бота: `SITE DEEPLINK INTENT: booking` (и т.д.)

Сообщения с сайта обрабатываются **до** приветствия и главного меню.
